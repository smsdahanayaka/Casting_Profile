...
//image 1
let inputImage1 = document.getElementById("formFileSm-1");
let imgView1 = document.getElementById("img-id-1");

// Add event listener to the file input
inputImage1.addEventListener('change', function () {
const selectedFile = inputImage1.files[0];
...
if (selectedFile) {
    ...
    // Define a callback function to execute when the reader has loaded the image
    reader.onload = function (event) {
        imgView1.src = event.target.result;
    };
...
let inputImage2 = document.getElementById("formFileSm-2");
let imgView2 = document.getElementById("img-id-2");

// Add event listener to the file input
inputImage2.addEventListener('change', function () {
const selectedFile = inputImage2.files[0];
...
if (selectedFile) {
    ...
    // Define a callback function to execute when the reader has loaded the image
    reader.onload = function (event) {
        imgView2.src = event.target.result;
    };
