            ...
            <div class="col-md-12">
              ...
              <div class="swiper-container client-swiper">
                    ...
                    <div class="container body-container">
                        <!-- registation form -->
                        <form class="row g-3" method="POST" action="{{ url('add-users') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="registation-form form-name row g-3">
                                ...
                                <div class="col-md-4 dateOfBirth">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="yyyy-mm-dd" name="date_of_birth" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" id="phone" type="tel" name="whatsapp_number" pattern="+94[0-9]{2}[0-9]{4}[0-9]{3}" placeholder="+94714567871" required/>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom02" placeholder="Home town" name="home_town" required>
                                </div>
                                <hr>
                            </div>
                            ...
                            <div class="registation-form form-sizing row g-3">
                                ...
                                <div class="col-lg-4 col-md-4 fname">
                                    ...
                                    <input type="text" class="form-control" placeholder="Hair Color" aria-label="Hair Color" name="hair_color">
                                </div>

                                <!-- eye color -->
                                <div class="col-lg-4 col-md-4 fname">
                                    <label for="inputEmail4" class="form-label">Eye color</label>
                                    <input type="text" class="form-control" placeholder="Eye color" aria-label="Eye color" name="eye_color">
                                </div>

                                <!-- shoe size -->
                                <div class="col-lg-6 col-md-6 fname">
                                    <label for="inputEmail4" class="form-label">Shoe size</label>
                                    <input type="text" class="form-control" placeholder="Shoe size" aria-label="Shoe size" name="shoe_size">
                                </div>

                                <!-- pants size -->
                                <div class="col-lg-6 col-md-6 fname">
                                    <label for="inputEmail4" class="form-label">Pants size</label>
                                    <input type="text" class="form-control" placeholder="Pants size" aria-label="Pants size" name="pants_size">
                                </div>

                                <!-- top size -->
                                <div class="col-lg-6 col-md-6 fname">
                                    <label for="inputEmail4" class="form-label">Top size</label>
                                    <input type="text" class="form-control" placeholder="Top size" aria-label="Top size" name="top_size">
                                </div>

                                <!-- dress size -->
                                <div class="col-lg-6 col-md-6 fname">
                                    <label for="inputEmail4" class="form-label">Dress size</label>
                                    <input type="text" class="form-control" placeholder="Dress size" aria-label="Dress size"  name="dress_size">
                                </div>
                                <hr>
                            </div>
                            ...
                            <div class="registation-form form-social-media row g-3">
                                ...
                                <div class="social col-lg-6 col-md-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="face book" aria-label="face book" name="facebook">
                                </div>
                                <!-- instagram -->
                                <div class="social col-lg-6 col-md-6">
                                    <i class="icon-sc fa-brands fa-instagram" style="color: #d60000;"></i>
                                    <input type="text" class="form-control" placeholder="Instagram" aria-label="face book" name="instagram">
                                </div>
                                <!-- tik tok -->
                                <div class="social col-lg-6 col-md-6">
                                    <i class="icon-sc fa-brands fa-tiktok"></i>
                                    <input type="text" class="form-control" placeholder="Tik Tok" aria-label="face book" name="tiktok">
                                </div>
                                <!-- you tube -->
                                <div class="social col-lg-6 col-md-6">
                                    <i class="icon-sc fa-brands fa-youtube" style="color: #b30000;"></i>
                                    <input type="text" class="form-control" placeholder="You Tube" aria-label="face book" name="youtube">
                                </div>
                                <hr>
                            </div>
