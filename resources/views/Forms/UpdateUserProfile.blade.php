...
@section('content')
    ...
    @section('content-nav')
        @extends('navbar.user.adminViewUserprofilenav')
    @endsection
                        ...
                        <form class="row g-3" method="POST" action="{{ url('update-users-done/' . $adminData->id) }}"
                            ...
                            <div class="registation-form form-social-media row g-3">
                                ...
                                <div class="col-lg-12 col-md-12 form-floating">
                                    ...
                                    <input type="text" class="form-control" value="{{ $adminData->remark }}"
                                        id="floatingTextarea" name="remark">
                            ...
                            <div class="registation-form form-social-media row g-3">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputPassword1"
                                        name="status" value="{{ $adminData->status }}">
                                </div>
                                <!-- password -->
                                <div class="col-lg-6 col-md-6">
